...
public enum Armor {
	...
	LEATHER_CHESTPLATE("leatherchest", 299, "Leather Chestplate", Material.LEATHER_CHESTPLATE),
	CHAIN_CHESTPLATE("chainchest", 303, "Chain Chestplate", Material.CHAINMAIL_HELMET),
	IRON_CHESTPLATE("ironchest", 307, "Iron Chestplate", Material.IRON_CHESTPLATE),
	DIAMOND_CHESTPLATE("diamondchest", 311, "Diamond Chestplate", Material.DIAMOND_CHESTPLATE),
