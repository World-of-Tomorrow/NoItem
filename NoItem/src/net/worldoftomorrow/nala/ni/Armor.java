...
public enum Armor {
    LEATHER_HELMET("leatherhelmet", 298, "Leather Helmet",
	    ...
	    "goldhelmet", 314, "Golden Helmet", Material.GOLD_HELMET),
    ...
    LEATHER_PANTS("leatherpants", 300, "Leather Pants",
	    Material.LEATHER_LEGGINGS), CHAIN_PANTS("chainpants", 304,
	    "Chain Pants", Material.CHAINMAIL_LEGGINGS), IRON_PANTS(
	    ...
	    "goldpants", 316, "Golden Pants", Material.GOLD_LEGGINGS),

    LEATHER_BOOTS("leatherboots", 301, "Leather Boots", Material.LEATHER_BOOTS), CHAIN_BOOTS(
